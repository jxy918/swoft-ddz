...
<form align=center>
    ...
    <div>
        请求类型：<select id="req_cmd" style="HEIGHT: 21px; WIDTH: 100px">
            ...
            <option value="GameCall">GameCall</option>
        </select>
...
<script src="client/Init.js?v13"></script>
<script src="client/Const.js?v17"></script>
<script src="client/Req.js?v13"></script>
<script src="client/Resp.js?v13"></script>
